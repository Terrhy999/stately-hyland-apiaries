...
const Resources = () => {
  return (
    <>
      <Head>
        <title>Beekeeping Resources - SHA</title>
      </Head>
      <div className="w-full prose prose-lg prose-blockquote:border-gray-500 prose-blockquote:bg-gray-300 prose-blockquote:overflow-auto font-lato">
        ...
        <blockquote>
          <p>
            A trick I learned when working on the Master Gardener Help Line was
            to get my information from only Educational sources. (This cut out
            advertising and misinformation.)
          </p>
          <p className="font-bold text-md">
            To become better educated in Beekeeping (or anything) it is
            important to get your information from educational resources.
          </p>
        </blockquote>
        <p>
        ...
        <p>
          For example, search for information on Cicada Killer Wasps by
          Googling:{" "}
