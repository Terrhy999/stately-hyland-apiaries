...
import ImagesGrid from "../../components/postTools/ImagesGrid";
...
Therefore, I decided to 'divide and conqur' and purchase a set of their own!
...
<PostImage
  ...
  caption={
    <>
      I started witht the old fashioned{" "}
      <a href="https://youtu.be/quvN7vg9dwc">galvanized gravity waterer</a>
    </>
  }
/>

While it looked amazingly nostalgic, it leaked terribly. In the winter, it had to be set on a heater to keep it from freezing (which din't work well) and it was very hard to keep it level and if it is not perfectly level, it leaks, like a sieve.
