...
export const meta = {
  ...
  date: "2022-06-02",
  caption: "Allow me to show you their undeniable cuteness! Introducing the Marquette \"Hennettes\"!"
...
_🐔 <span className="underline"</span>: Dual purpose breed (layer & meat chicken), brown eggs, with the feathers having gold flecks on black plumage._
